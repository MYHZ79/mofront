...
function App() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    // Check if user is authenticated (implement your auth check here)
          ...
          <div className="text-white">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
              <div className="bg-red-500 rounded-2xl p-12">
                ...
                <button className="px-8 py-4 bg-black rounded-lg font-bold hover:bg-gray-900 transition-colors flex items-center gap-2 mx-auto">
                  همین حالا شروع کن
                  <ArrowLeft className="w-5 h-5" />
                </button>
              </div>
